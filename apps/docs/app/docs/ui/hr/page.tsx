...
export default function Page() {
    return (
        <Container size="md">
            ...
            <h3>Variant:</h3>
            <p>
                Here we have listed all kinds of HR features for you and given
                an example.
            </p>
            <Card>
                <h4>Normal Hr:</h4>
            ...
            <Card>
                ...
                <p>
                    ...
                    follow a broken or dead link; hence the 404 error is one of
                    the most recognizable errors encountered on the World Wide
                    Web.
                </p>
